...
You can view the scaffold package on PyPi here: "http://pypi.python.org/pypi/Scaffold/0.1.1":http://pypi.python.org/pypi/Scaffold/0.1.1
...
<pre>python -m scaffold -p "http-utils" -d /c/repositories/
python -m scaffold -p "mutliplex-py"
python -m scaffold -p "lazarus" -d ../</pre>
